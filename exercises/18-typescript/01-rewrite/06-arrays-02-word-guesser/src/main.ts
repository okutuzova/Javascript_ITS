 ...
 * Exercise 06-arrays-02-word-guesser-typescript
 * 
 * This script simulates a simple "Hangman" game where a player guesses letters 
 * to complete a hidden word. 
 * The word is stored as an array of strings, and the player has a limited 
 * number of attempts (6 guesses) 
 * to reveal all the letters. The script is rewritten in TypeScript.
 */
 ...
 * @constant {string[]}
 */
const guessedLetters: Array<string> = ['_', '_','_'];
